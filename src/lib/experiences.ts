    ...
    highlights: [
      {
        ...
        desc: "Bwindi and Kibale sit within a comfortable drive or short flight of each other.",
      },
      {
      ...
      },
      {
        ...
        desc: "Chimp trekking suits a wider range of fitness levels and a lower minimum age.",
      },
      {
        title: "Different energy entirely",
        desc: "One is reverent and still; the other is fast, loud, and full of drama.",
      },
    ],
    destinations: [
    ...
    faqs: [
      {
        ...
        a: "Yes — it's one of our most-booked combinations. Bwindi and Kibale are close enough to combine comfortably in a single itinerary, and our Primates Adventure journey is built around exactly this.",
      },
      {
        q: "Which has a higher success rate of finding the animals?",
        a: "Both are very high — trackers monitor habituated families and communities daily. Gorilla trekking success rates are typically slightly higher, since gorilla groups move less than chimp communities.",
      },
      {
        q: "Is the chimp trek less physically demanding?",
        a: "Generally yes, though it depends on the day — chimps move faster and further than gorillas, so a chimp trek can occasionally be more physically demanding despite the shorter official time limit.",
      },
      {
        q: "Do I need separate permits?",
        a: "Yes, gorilla and chimp permits are issued separately by the Uganda Wildlife Authority, and we arrange both as part of your itinerary.",
      },
    ],
  },
  {
    ...
    highlights: [
      {
        ...
        desc: "The only chimpanzee encounter in Uganda open to children under 12.",
      },
      {
        title: "Murchison Falls game drives & cruise",
        desc: "No hiking required — ideal for younger children and a near-guaranteed wildlife payoff.",
      },
      {
        title: "Lake Bunyonyi canoeing",
        desc: "One of the few swimmable lakes in the region, at an easy, unhurried pace.",
      },
      {
        title: "Chimp trekking from age 12",
        desc: "A genuine primate encounter for families with older children not yet 15.",
      },
      {
        title: "Private vehicles as standard",
        desc: "Flexible pacing, no group schedule to keep up with.",
      },
      {
        title: "Gorilla trekking for the 15+ in the family",
        desc: "Older teens and adults can still trek while younger siblings enjoy Murchison or Bunyonyi.",
      },
    ],
    destinations: [
    ...
    faqs: [
      {
        ...
        a: "Only family members aged 15 and over. Uganda allows a rare case-by-case exception for a mature 14-year-old approaching their 15th birthday, decided directly by the Uganda Wildlife Authority — but this isn't guaranteed and requires advance paperwork.",
      },
      {
        q: "What's the minimum age for chimp trekking?",
        a: "Generally around 12, though this varies by location — we'll confirm current rules for the specific forest when we plan your trip.",
      },
      {
        q: "Is there anything for children under 12?",
        a: "Yes — Ngamba Island's chimpanzee sanctuary near Entebbe has no minimum age, and Murchison Falls' game drives and boat cruise require no hiking or age restriction.",
      },
      {
        q: "Do you arrange split itineraries — some family members trekking, others not?",
        a: "Regularly. A common pattern is older family members gorilla trekking while younger children and a second guide spend the morning at the lodge or on a gentler nearby activity.",
      },
    ],
  },
  {
    ...
    highlights: [
      {
        title: "Private vehicle & guide throughout",
        desc: "No shared group schedule — the trip moves at your pace.",
      },
      {
        title: "A shared bucket-list moment",
        desc: "Gorilla trekking together in Bwindi, a memory built for two.",
      },
      {
        title: "Lake Bunyonyi for total quiet",
        desc: "No game drives, no alarms — just water, hills, and time.",
      },
      {
        title: "An adrenaline day if you want one",
        desc: "Jinja's white water rafting adds contrast to a slower itinerary.",
      },
      {
        title: "Honeymoon lodge upgrades",
        desc: "Private decks, romantic dining and suite upgrades arranged with partner lodges.",
      },
      {
        title: "Flexible pacing",
        desc: "Sleep in, linger over breakfast — nothing here runs on a group clock.",
      },
    ],
    destinations: [
      { name: "Gorilla Trekking, Bwindi", to: "/destinations/gorilla-trekking" },
    ...
    faqs: [
      {
        q: "Is a private vehicle really necessary?",
        a: "Not strictly, but almost every honeymooning couple tells us afterward it was worth it — no shared schedule, no compromise on pace, and a noticeably more intimate feel to the whole trip.",
      },
      {
        q: "How long should a honeymoon safari be?",
        a: "Our Gorilla Escape (3 days) works well as an add-on to a longer trip elsewhere in Africa; the 7-day Pearl of Africa route gives a fuller honeymoon in its own right.",
      },
      {
        q: "Can you arrange surprises — proposals, anniversaries, celebrations?",
        a: "Yes, regularly — let us know what you have in mind and we'll work it into the itinerary with the lodges directly.",
      },
      {
        q: "Is gorilla trekking too strenuous for a relaxed honeymoon?",
        a: "It's a moderate-to-strenuous hike, but most couples find the encounter itself more than worth the effort — and we always pair it with slower days either side.",
      },
    ],
  },
  {
    ...
    excerpt:
      "White water rafting, mountain trekking, and hot air balloons — Uganda's adventure activities, and how to combine them into one trip.",
    ...
    highlights: [
      {
        title: "Grade 3–5 white water rafting",
        desc: "Roughly 20km of Nile rapids at Jinja, rideable year-round.",
      },
      {
        title: "44-metre Nile bungee",
        desc: "A second adrenaline hit on the same day as rafting, if you want it.",
      },
      {
        title: "Margherita Peak expedition",
        desc: "A 7–9 day glacier trek to Africa's third-highest summit.",
      },
      {
        title: "Physically demanding primate treks",
        desc: "Gorilla and chimp trekking both involve genuine, sometimes strenuous hiking.",
      },
      {
        title: "Dawn hot air balloon safari",
        desc: "A silent, aerial view of Murchison Falls' savanna and the Nile gorge.",
      },
      {
        title: "Combine two or three in one trip",
        desc: "Jinja, the Rwenzori and a primate trek sit within a comfortable circuit of each other.",
      },
    ],
    destinations: [
      { name: "Jinja, Source of the Nile", to: "/destinations/jinja-source-of-the-nile" },
    ...
    faqs: [
      {
        ...
        a: "It depends which activities you choose — white water rafting requires no particular fitness beyond basic swimming ability, while a Margherita Peak summit attempt demands genuine multi-day trekking fitness. We'll help match activities to your fitness level.",
      },
      {
        q: "Can I raft the Nile and go gorilla trekking on the same trip?",
        a: "Yes — this is one of our most popular adventure combinations, and Jinja works well as a first or last stop given its short distance from Kampala and Entebbe.",
      },
      {
        q: "Is a Rwenzori summit attempt necessary, or can I still get the experience without it?",
        a: "Shorter, lower-altitude day hikes into the Rwenzori foothills offer genuine mountain scenery — waterfalls, forest, hot springs — without any technical climbing or multi-day commitment.",
      },
      {
        q: "Is white water rafting safe?",
        a: "Jinja's operators run to international safety standards with safety kayakers on every trip. No prior rafting experience is required.",
      },
    ],
  },
  {
    ...
    excerpt:
      "Big game, open plains, and the parks that deliver Uganda's most reliable wildlife viewing.",
    ...
    highlights: [
      {
        title: "Murchison Falls' big herds",
        desc: "Uganda's largest elephant, giraffe and buffalo populations.",
      },
      {
        title: "Tree-climbing lions, Ishasha",
        desc: "One of only two places in Africa where lions regularly climb trees.",
      },
      {
        title: "Kazinga Channel boat safari",
        desc: "The highest hippo concentration in Africa, alongside strong birding.",
      },
      {
        title: "Kidepo's cheetah",
        desc: "Remote, uncrowded savanna with one of Uganda's only cheetah populations.",
      },
      {
        title: "Dawn & dusk game drives",
        desc: "Timed to when wildlife is most active, in a private vehicle.",
      },
      {
        title: "Walking & boat options",
        desc: "Lake Mburo and the Kazinga Channel add variety beyond the vehicle.",
      },
    ],
    destinations: [
      { name: "Murchison Falls", to: "/destinations/murchison-falls" },
    ...
    faqs: [
      {
        q: "Which park has the most wildlife?",
        a: "Murchison Falls has Uganda's largest herds by volume. Queen Elizabeth offers the widest variety in one park, including tree-climbing lions. Kidepo trades some density for total isolation and species found nowhere else, like cheetah.",
      },
      {
        q: "Do I need multiple parks for a good wildlife safari?",
        a: "Not necessarily — Murchison Falls or Queen Elizabeth alone deliver a full big-game experience. Combining two adds variety, particularly if you want both tree-climbing lions and the Nile.",
      },
      {
        q: "Are wildlife safaris combinable with gorilla trekking?",
        a: "Yes — this is one of the most common Uganda itineraries, typically pairing Queen Elizabeth or Murchison Falls with a few days in Bwindi or Mgahinga.",
      },
    ],
  },
  {
    ...
    excerpt:
      "Premium camps, private guides and fly-in transfers — a high-end Uganda safari without the crowds of neighbouring countries.",
    heroImg: expLodge,
    intro:
    ...
    highlights: [
      {
        ...
        desc: "One guide, one vehicle, for the full length of your trip.",
      },
      {
        title: "Fly-in transfers",
        desc: "Scheduled light aircraft between regions instead of long road transfers.",
      },
      {
        title: "Boutique, low-density camps",
        desc: "A handful of rooms rather than large-scale lodges, in genuinely quiet settings.",
      },
      {
        title: "Priority gorilla permits",
        desc: "Advance booking for the sectors and dates that suit your itinerary.",
      },
      {
        title: "Flexible, unhurried pacing",
        desc: "No fixed group schedule — the day moves at your pace.",
      },
      {
        title: "Considerably better value than East Africa's classic circuits",
        desc: "Comparable luxury for a fraction of the visitor density.",
      },
    ],
    destinations: [
    ...
    faqs: [
      {
        q: "How does Uganda's luxury safari scene compare to Kenya or Tanzania?",
        a: "Fewer, smaller camps, far lower visitor density even at premium properties, and generally better value for a comparable standard of accommodation and guiding.",
      },
      {
        q: "Can I do a fully private gorilla trek?",
        a: "Standard permits place you in a group of up to eight with other trekkers. A private, extended alternative is the Gorilla Habituation Experience in Rushaga, which runs in smaller numbers for a longer encounter.",
      },
      {
        q: "Is fly-in travel necessary for a luxury trip?",
        a: "It's optional but popular — it cuts multi-hour road transfers to under an hour between most regions, which matters if your trip is shorter or you're combining several parks.",
      },
    ],
  },
  {
    ...
    excerpt:
      "The shoebill stork, Albertine Rift endemics, and a bird list longer than almost anywhere else on the continent.",
    heroImg: expShoebill,
    intro:
    ...
    highlights: [
      {
        title: "Shoebill stork at Mabamba Swamp",
        desc: "A quiet canoe trip near Lake Victoria for Uganda's most sought-after bird.",
      },
      {
        title: "Over 1,000 recorded species",
        desc: "More than any other country in Africa, in a compact geographic area.",
      },
      {
        title: "Albertine Rift endemics",
        desc: "Species found nowhere else on Earth, concentrated in Bwindi and the Rwenzori.",
      },
      {
        title: "Semuliki's Congo-basin species",
        desc: "A bird list shared with Central Africa, unlike anywhere else in Uganda.",
      },
      {
        title: "Kazinga Channel water birds",
        desc: "Pelicans, kingfishers and fish eagles alongside the channel's hippo population.",
      },
      {
        title: "Specialist birding guides",
        desc: "Guides who work birding-specific pacing rather than a standard game-drive schedule.",
      },
    ],
    destinations: [
    ...
    faqs: [
      {
        q: "When is the best time for birding in Uganda?",
        a: "Birding is strong year-round, but November–April adds Palearctic migrants to the resident species, making it the peak season for the longest possible checklist.",
      },
      {
        q: "Do I need a specialist guide?",
        a: "For a serious birding trip, yes — we pair birding itineraries with guides who specialise in bird identification and calls, rather than a standard safari guide.",
      },
      {
        q: "Is the shoebill guaranteed?",
        a: "No wild sighting is ever guaranteed, but Mabamba Swamp and the Murchison Falls delta offer consistently good odds given local knowledge of current nesting and feeding areas.",
      },
    ],
  },
  {
    ...
    excerpt:
      "Golden-hour game drives, photography-friendly vehicles, and Uganda's most photogenic landscapes.",
    heroImg: ctaSunset,
    intro:
    ...
    highlights: [
      {
        title: "Photography-briefed guides",
        desc: "Positioning for light and angle, not just proximity.",
      },
      {
        title: "Dawn & dusk-timed drives",
        desc: "Built around golden hour, not standard meal or transfer schedules.",
      },
      { title: "Extended time on sightings", desc: "No rush to move on once a scene is working." },
      {
        title: "Uganda's most dramatic landscapes",
        desc: "Murchison's gorge, Bwindi's mist, the Rwenzori's glaciers.",
      },
      {
        title: "Low-light primate guidance",
        desc: "Lens and settings advice for Bwindi and Kibale's dense forest canopy.",
      },
      {
        title: "Optional private vehicle",
        desc: "Full control over positioning without sharing a sighting with other guests.",
      },
    ],
    destinations: [
      { name: "Murchison Falls", to: "/destinations/murchison-falls" },
    ...
    faqs: [
      {
        q: "Do I need a private vehicle for photography?",
        a: "It's strongly recommended — sharing a vehicle means compromising on positioning and timing to suit other guests' preferences.",
      },
      {
        q: "Can I bring professional camera equipment on gorilla treks?",
        a: "Yes — most photographers bring a mid-range zoom rather than heavy telephoto gear, given the close range and dense, low-light forest conditions.",
      },
      {
        q: "Is there a separate photography permit for gorillas?",
        a: "No separate permit is required for standard photography; flash is prohibited around gorillas to protect their eyes, so low-light technique matters more than equipment.",
      },
    ],
  },
  {
    ...
    tagline:
      "Uganda's parks, connected by scheduled light aircraft instead of long road transfers.",
    excerpt:
      "Cut multi-hour drives to under an hour, and see Uganda's landscapes from the air along the way.",
    heroImg: nileBridgeAerial,
    intro:
    ...
    highlights: [
      {
        title: "Under an hour between most parks",
        desc: "Compared to 5–11 hours by road, depending on the route.",
      },
      {
        title: "Kidepo made practical",
        desc: "Uganda's most remote park becomes a realistic add-on rather than a full-day commitment each way.",
      },
      {
        title: "Aerial views included",
        desc: "The Rift Valley, the Nile and the Rwenzori's peaks, seen from the air en route.",
      },
      {
        title: "More time on the ground",
        desc: "Extra time for activities instead of transfers, on a shorter trip.",
      },
      {
        title: "Scheduled, not chartered",
        desc: "Regular scheduled flights keep costs well below a private charter.",
      },
      {
        title: "Combine with road transfers",
        desc: "Fly one leg, drive another — itineraries mix and match by route.",
      },
    ],
    destinations: [
      { name: "Kidepo Valley", to: "/destinations/kidepo-valley" },
    ...
    faqs: [
      {
        q: "How much does a fly-in safari add to the cost?",
        a: "More than a road transfer, but the difference narrows considerably on longer or more remote routes like Kidepo, where the time saved is substantial.",
      },
      {
        q: "What's the baggage limit?",
        a: "Typically around 15kg per person in a soft-sided bag, given the size of the aircraft used on these routes.",
      },
      {
        q: "Can I mix flying and driving on one trip?",
        a: "Yes — a common pattern is flying into a remote park like Kidepo and driving the more scenic, shorter legs elsewhere.",
      },
    ],
  },
  {
    ...
    excerpt:
      "From Lake Mburo's free-roaming plains game to guided forest treks and multi-day mountain hikes.",
    heroImg: elephantSavanna,
    intro:
    ...
    highlights: [
      {
        title: "Lake Mburo walking & horseback safaris",
        desc: "The only park where walking among plains game is routine.",
      },
      {
        title: "Multi-day mountain treks",
        desc: "Rwenzori and Mount Elgon summit routes, several days of trail on foot.",
      },
      {
        title: "Guided forest nature walks",
        desc: "Lower-impact walks through Bwindi and Kibale's edges, without a trekking permit.",
      },
      {
        title: "Batwa Trail",
        desc: "A guided cultural walk retracing forest life with the region's original inhabitants.",
      },
      {
        title: "Sipi Falls day walks",
        desc: "A gentler multi-waterfall walk on Mount Elgon's lower slopes.",
      },
      {
        title: "Community & village walks",
        desc: "Karamojong and Batwa community encounters on foot, guided by local hosts.",
      },
    ],
    destinations: [
      { name: "Lake Mburo", to: "/destinations/lake-mburo" },
    ...
    faqs: [
      {
        q: "Is walking safe in Uganda's parks?",
        a: "Where it's officially permitted — Lake Mburo, guided forest trails, and mountain treks — yes, always with an armed ranger or experienced guide. Most parks restrict free walking specifically because of elephant and lion risk.",
      },
      {
        q: "Do I need special fitness for a walking safari?",
        a: "A Lake Mburo walk or forest nature walk needs only basic fitness. A multi-day Rwenzori or Mount Elgon trek requires genuine hiking fitness given the duration and altitude gain.",
      },
      {
        q: "Can I combine walking safaris with gorilla trekking?",
        a: "Yes — the Batwa Trail near Bwindi is a popular pairing, done either the day before or after a gorilla trek.",
      },
    ],
  },
  {
    ...
    excerpt:
      "Independent travel with a rented 4x4 — practical on Uganda's main routes, with the right preparation.",
    ...
    highlights: [
      {
        ...
        desc: "Your own vehicle, your own schedule, no group or guide pace to match.",
      },
      {
        title: "Well-suited southern circuit",
        desc: "Lake Mburo, Bwindi, Queen Elizabeth and Kibale on reasonably maintained roads.",
      },
      {
        title: "4x4 rental arranged",
        desc: "A properly equipped vehicle for park roads, not just highway driving.",
      },
      {
        title: "Permits still handled for you",
        desc: "Gorilla and chimp permits pre-booked regardless of how you're travelling.",
      },
      {
        title: "Route planning included",
        desc: "A realistic day-by-day plan matched to road conditions and driving time.",
      },
      {
        title: "Not recommended for every route",
        desc: "We'll advise honestly on which legs suit self-driving and which don't.",
      },
    ],
    destinations: [
      { name: "Lake Mburo", to: "/destinations/lake-mburo" },
    ...
    faqs: [
      {
        q: "Is self-driving in Uganda safe?",
        a: "On the main southern and western circuit, yes, with normal travel precautions — reasonable roads, clear routes, and reliable fuel stops. We'll advise against self-driving specific remote legs where conditions don't suit it.",
      },
      {
        q: "Do I need a 4x4?",
        a: "Yes — park roads are unpaved and can be rutted or muddy, particularly in the wet season, regardless of how good the highway is beforehand.",
      },
      {
        q: "Can you still arrange gorilla permits if I'm self-driving?",
        a: "Yes — permits, lodge bookings and your route plan are arranged the same way regardless of whether you're driving yourself or being guided.",
      },
    ],
  },
];
