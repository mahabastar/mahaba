...
const INSPIRATION_LINKS: { label: string; to: string; desc: string }[] = [
  {
    ...
    desc: "Searchable guide to Uganda's species",
  },
...
const PLAN_LINKS: { label: string; to: string; desc: string }[] = [
  { label: "Request a Quote", to: "/quote-request", desc: "A fast, no-obligation quote" },
  {
    ...
    desc: "What's best, month by month",
  },
  ...
  {
    label: "Gorilla Permit Guide",
    to: "/gorilla-permit-guide",
    desc: "What the USD 800 permit includes",
  },
        ...
        >
          <Link to="/" className="flex items-center gap-3 text-ivory">
            <img
              ...
              className="h-11 w-11 shrink-0 rounded-full bg-ivory object-contain p-0.5 ring-1 ring-gold/50 md:h-12 md:w-12"
            />
        ...
        {mobileOpen && (
          <div className="fixed inset-0 z-[60] flex flex-col bg-charcoal grain md:hidden">
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-10">
              ...
              <div className="mt-6">
                <div className="px-2 text-xs uppercase tracking-widest text-ivory/40">
                  Inspiration
                </div>
                <div className="mt-2 flex flex-col">
                  {INSPIRATION_LINKS.map((l) => (
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 border-b border-charcoal/10 px-5 py-4">
                ...
                <button
                  onClick={() => setSearchOpen(false)}
                  className="text-xs uppercase tracking-widest text-charcoal/40 hover:text-forest"
                >
                  Esc
                </button>
              </div>
                ...
                {results.length === 0 ? (
                  ...
                  results.map((r) => (
                    ...
                    >
                      ...
                      <span className="text-[0.65rem] uppercase tracking-widest text-charcoal/40">
                        {r.category}
                      </span>
                    </Link>
                  ))
